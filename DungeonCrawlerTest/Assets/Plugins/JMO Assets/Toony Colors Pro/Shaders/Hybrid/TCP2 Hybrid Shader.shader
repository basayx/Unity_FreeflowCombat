...
Shader "Toony Colors Pro 2/Hybrid Shader"
{
	...
	//# ========================================================
	//# Base
		[Toggle(GRADIENT_COLOR_EXTENSION_ON)] _UseGradientColorExtension ("Use Gradient Color Extension", Float) = 0
		//# IF_KEYWORD GRADIENT_COLOR_EXTENSION_ON
		_colorStart ("Color Start", Color) = (1.0, 1.0, 1.0, 1.0)
		_colorMid ("Color Mid", Color) = (0.5, 0.5, 0.5, 1.0)
		_colorEnd ("Color End", Color) = (0.0, 0.0, 0.0, 1.0)
        _middle ("Middle", Range(0.001, 0.999)) = 0.5
		[Toggle(USE_WORLD_COORDINATES_FOR_GRADIENT)] _useWorldCoordinates ("Use World Coordinates For Gradient", Float) = 1
			//# IF_KEYWORD USE_WORLD_COORDINATES_FOR_GRADIENT
			[Toggle(USE_REALTIME_WORLD_POSITION_FOR_GRADIENT)] _useRealtimeWorldPosition ("Use Realtime World Position For Gradient", Float) = 1
				//# IF_KEYWORD USE_REALTIME_WORLD_POSITION_FOR_GRADIENT
				_parentY ("Parent Y Position", Float) = 0.0
				//# END_IF
			//# END_IF
		//# END_IF
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile _ GRADIENT_COLOR_EXTENSION_ON
			#pragma multi_compile _ USE_WORLD_COORDINATES_FOR_GRADIENT
			#pragma multi_compile _ USE_REALTIME_WORLD_POSITION_FOR_GRADIENT
